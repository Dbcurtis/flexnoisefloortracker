...
class Testsmeter(unittest.TestCase):
    ...
    def testinstat(self):
        ...
        """
        #SMArgkeys('ZZSM000;', 5_000_000)
        #_sm = SMeter(('ZZSM000;', 5_000_000))
        _sm = SMeter(SMArgkeys('ZZSM000;', 5_000_000))
        self.assertEqual(
        ...
        _sm = SMeter(SMArgkeys('ZZSM260;', 14_123_456))  # "S9+70"
        ...
        sms = [SMeter(SMArgkeys('ZZSM{:03};'.format(i), i * 100000))
        ...
        _sm1 = SMeter(SMArgkeys('ZZSM260;', 14_123_456))  # "S9+70"
        _sm2 = SMeter(SMArgkeys('ZZSM260;', 14_123_456))  # "S9+70"
        _sm3 = SMeter(SMArgkeys('ZZSM098;', 12_123_444))
